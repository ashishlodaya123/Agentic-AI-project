...
const ClinicalVisualizations = ({
            ...
            {vitalData.data.map((vital, index) => (
              ...
              >
                ...
                <div className="text-2xl font-bold text-neutral-text mb-1">
                  {vital.value}{" "}
                  <span className="text-sm font-normal text-neutral-text-secondary">
                    {vital.unit}
                  </span>
                </div>
                <div className="text-sm text-neutral-text-secondary">
                  Normal: {vital.normal_range[0]}-{vital.normal_range[1]}{" "}
                  {vital.unit}
                </div>
        ...
        <div className="card-body">
          <div className="space-y-6">
            {Object.entries(groupedEvents).map(([time, events], timeIndex) => (
              <div
                key={timeIndex}
                className="border-l-2 border-primary pl-4 ml-3"
              >
                <div className="mb-3">
                ...
                <div className="space-y-3">
                  {events.map((event, eventIndex) => (
                    <div
                      key={eventIndex}
                      className="border border-neutral-border rounded-lg p-3 ml-2"
                    >
  ...
  const renderSymptomChart = (symptomData) => {
        ...
        <div className="card">
          <div className="card-header">
            <div className="flex items-center">
              ...
              <h3 className="h3 text-neutral-text">
                Symptom Distribution by System
              </h3>
            </div>
          </div>
          <div className="card-body">
    ...
    const totalSymptoms = symptomData.symptoms.reduce(
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              {symptomData.symptoms.map((item, index) => {
                const percentage =
                  totalSymptoms > 0 ? (item.count / totalSymptoms) * 100 : 0;
                return (
                  <div
                    key={index}
                    className="border border-neutral-border rounded-lg p-3"
            ...
            <div className="flex items-center justify-center">
              <div className="relative w-64 h-64">
                {symptomData.symptoms.map((item, index) => {
                  const percentage =
                    totalSymptoms > 0 ? (item.count / totalSymptoms) * 100 : 0;
                  const rotation = symptomData.symptoms
                    .slice(0, index)
                    .reduce((sum, prevItem) => {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        clipPath: `path('M 50,50 L 50,0 A 50,50 0 ${
                          percentage > 50 ? 1 : 0
                        },1 ${
                          50 +
                          50 *
                            Math.cos(
                              ((rotation + percentage * 3.6 - 90) * Math.PI) /
                                180
                            )
                        },${
                          50 +
      ...
      <div className="card">
        ...
        <div className="card-body">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="border border-neutral-border rounded-lg p-4 text-center">
              <div className="text-2xl font-bold text-neutral-text">
                {summaryData.medical_history_count}
              </div>
              <div className="body-small text-neutral-text-secondary">
                Medical Conditions
              </div>
            ...
            <div className="border border-neutral-border rounded-lg p-4">
              ...
              <div className="text-neutral-text mt-1">
          ...
          {summaryData.vital_signs_summary &&
            summaryData.vital_signs_summary !== "Not recorded" && (
              <div className="mt-3">
                <h4 className="font-medium text-neutral-text mb-1">
                  Vital Signs
                </h4>
                <div className="body-small text-neutral-text-secondary">
                  {summaryData.vital_signs_summary}
      ...
      {loading ? (
        <div className="text-center py-8">
          ...
          <p className="body-large text-neutral-text-secondary">
            Loading clinical visualizations...
          </p>
        </div>
      ) : error ? (
        <div className="text-center py-8">
        ...
        <div className="text-center py-8">
          ...
          <p className="body-large text-neutral-text-secondary">
            Clinical visualizations will be generated based on patient data and
            clinical analysis.
          </p>
        </div>
      )}
