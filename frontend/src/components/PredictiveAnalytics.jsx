...
const PredictiveAnalytics = ({
  ...
  if (
    !analyticsData ||
    !analyticsData.complication_predictions ||
    analyticsData.complication_predictions.length === 0
  ) {
    return (
      <div className="text-center py-8">
        <FaChartArea className="mx-auto h-12 w-12 text-gray-300 mb-3" />
        <p className="body-large text-neutral-text-secondary">
          No predictive analytics data available. This feature requires
  ...
  // Sort by risk score
  const sortedPredictions = [...analyticsData.complication_predictions].sort(
        ...
        <div className="card">
          <div className="card-body text-center">
            <div className="text-3xl font-bold text-warning">
              {
                sortedPredictions.filter((p) => p.risk_level === "moderate")
                  .length
              }
            </div>
            <div className="body-small text-neutral-text-secondary">
            ...
            <div className="card-body">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div>
                  ...
                  <div className="flex flex-wrap gap-1">
                    {prediction.risk_factors_present.map(
                      (factor, factorIndex) => (
                        <span
                          key={factorIndex}
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1">
                    {prediction.indicators_present.map(
              ...
              <div className="mt-4 pt-4 border-t border-neutral-border">
                ...
                <ul className="list-disc pl-5 space-y-1">
                  {prediction.prevention_strategies?.map(
